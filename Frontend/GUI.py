...
class CustomTopBar(QWidget):
    ...
    def initUI(self):
        ...
        closed_button = QPushButton()
        close_icon = QIcon(GraphicsDirectoryPath('Close.png'))
        closed_button.setIcon(close_icon)
        closed_button.setStyleSheet("background-color: white")
        closed_button.clicked.connect(self.closeWindow)
        line_frame = QFrame()
